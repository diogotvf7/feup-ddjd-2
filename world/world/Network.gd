...
var peer: ENetMultiplayerPeer          # holds the ENet host/client

const DEFAULT_PORT := 8910

func _ready() -> void:
	# hook up MultiplayerAPI signals once, for the whole game
...
func host(port:int = DEFAULT_PORT, max_clients:int = 4) -> void:
	...
	# Add host to GameManager immediately
...
func _on_connected_to_server() -> void:
	...
	# The client tells host its name
