...
func _on_rpg_timer_timeout() -> void:
	$Skeleton/Hand/RPG/MuzzleFlash.visible = false

func _on_pistol_timer_timeout() -> void:
	$Skeleton/Hand/Pistol/MuzzleFlash.visible = false

func _on_shotgun_timer_timeout() -> void:
	$Skeleton/Hand/Shotgun/MuzzleFlash.visible = false
